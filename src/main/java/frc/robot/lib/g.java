 ...
 * relevant java classes like: ROBOT, OI/"OperatorInterface", and CAN IDs
 * The "static" keyword means these classes and there static data are available
 * to all other classes in the project and they never need to have a new
 * instance made to access the internal static data.
 * <p>
 * These classes should contain 2 types of data:
 * <ul>
 * <li><b>Data</b> are values of some type that can change during the program
 * execution. Example: <i>"double static volatile robotAngle_deg;" </i>
 * </li>
 * <li><b>Constants</b> are values of some type that CANNOT change during the
 * program execution. Example: <i>"double static final LENGTH_mm = 320.0;"</i>
 * </li>
 * </ul>
 * <p>
 ...
 * word is appended with a underscore followed by the abbreviated units as
 * showin in units area.
 * <b>Constancs</b> are labeled with capitol letters with an underscore
 * seperating each name.If units are appropriate the word is appended with a
 * underscore followed by the abbreviated units as shown in units area.
 * <p>
 * <b>Units</b>
 * <p>
 * deg,rad,in,mm,m,sec,ft,rot
 * degPsec, ftPsec, mPsec
 * 
 * 
 * 
 */
